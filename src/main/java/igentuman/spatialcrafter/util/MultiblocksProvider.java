package igentuman.spatialcrafter.util;
...
import static igentuman.spatialcrafter.Main.rlFromString;
...
public class MultiblocksProvider implements PreparableReloadListener {
    ...
    private static List<MultiblockStructure> loadMultiblockStructures(ResourceManager resourceManager) {
        ...
        Map<ResourceLocation, Resource> structureFiles = resourceManager.listResources("spatial_structures",
